...
def scene_generator():
    ...
    variable_list = ["discipline", "satisfaction"]

    num_choices = 3

    options = []
    for choice in range(num_choices):
        num_vars = random.randint(1, 1)
        selected_vars = random.sample(variable_list, k=num_vars)
        option_dict = {}
        for var in selected_vars:
            option_dict[var] = random.choice([-2, 2])
...
if __name__ == "__main__":
    ...
    player1_traits_sample = random.sample(traits, k=1)
    ...
    player2_traits_sample = random.sample(traits, k=1)
    ...
    player1_features_sample = random.sample(features, k=1)
    ...
    player2_features_sample = random.sample(features, k=1)
