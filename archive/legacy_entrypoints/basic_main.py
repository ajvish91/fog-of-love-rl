...
class Run:
    def __init__(self, check_affinity_condition, gpu, aff_idx_1, aff_idx_2, is_abrl=False, debug=False):
...
if __name__ == "__main__":
    print(sys.argv)
    if len(sys.argv) != 6:
        print("Usage: python script.py <debug==0|1> <abrl==0|1> <gpu==0-11> <aff_idx_2==14-20> <aff_idx_2==14-20>")
        sys.exit(1)
    debug = sys.argv[1]
