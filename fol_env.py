...
class FoLEnvironment(gym.Env):
    def __init__(self, debug=False):
        super(FoLEnvironment, self).__init__()

        # Define the action and observation spaces
        self.personality_names = ["discipline", "curiosity", "extraversion", "sensitivity", "gentleness", "sincerity"]
        self.satisfaction_name = "satisfaction"
        self.goal_names = ["discipline", "curiosity", "extraversion", "sensitivity", "gentleness", "sincerity", "satisfaction"]
        ...
        self.observation_space = {"player_1": spaces.Dict({
            ...
            "player_1_curiosity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_1_extraversion": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_1_sensitivity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_1_gentleness": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_1_sincerity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_1_satisfaction": spaces.Discrete(50),
            "player_2_discipline": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_curiosity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_extraversion": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_sensitivity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_gentleness": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_sincerity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "player_2_satisfaction": spaces.Discrete(50),
            "option_1_discipline": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_1_curiosity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_1_extraversion": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_1_sensitivity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_1_gentleness": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_1_sincerity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            ...
            "option_2_curiosity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_2_extraversion": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_2_sensitivity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_2_gentleness": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_2_sincerity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            ...
            "option_3_curiosity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_3_extraversion": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_3_sensitivity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_3_gentleness": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            "option_3_sincerity": spaces.Box(low=-1, high=1, shape=(), dtype=np.int32),
            ...
            "goal_curiosity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "goal_extraversion": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "goal_sensitivity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "goal_gentleness": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
            "goal_sincerity": spaces.Box(low=-50, high=50, shape=(), dtype=np.int32),
    ...
    def reset(self):
        ...
        self.state = {  
            "player_1": {
                ...
                "player_1_curiosity": player_1.get_personality_tokens_by_key("curiosity"),
                "player_1_extraversion": player_1.get_personality_tokens_by_key("extraversion"),
                "player_1_sensitivity": player_1.get_personality_tokens_by_key("sensitivity"),
                "player_1_gentleness": player_1.get_personality_tokens_by_key("gentleness"),
                "player_1_sincerity": player_1.get_personality_tokens_by_key("sincerity"),
                ...
                "player_2_curiosity": player_2.get_personality_tokens_by_key("curiosity"),
                "player_2_extraversion": player_2.get_personality_tokens_by_key("extraversion"),
                "player_2_sensitivity": player_2.get_personality_tokens_by_key("sensitivity"),
                "player_2_gentleness": player_2.get_personality_tokens_by_key("gentleness"),
                "player_2_sincerity": player_2.get_personality_tokens_by_key("sincerity"),
                ...
                "player_1_goal_curiosity": player_1.get_trait_by_personality("curiosity"),
                "player_1_goal_extraversion": player_1.get_trait_by_personality("extraversion"),
                "player_1_goal_sensitivity": player_1.get_trait_by_personality("sensitivity"),
                "player_1_goal_gentleness": player_1.get_trait_by_personality("gentleness"),
                "player_1_goal_sincerity": player_1.get_trait_by_personality("sincerity"),
            ...
            "player_2": {
                ...
                "player_2_goal_curiosity": player_2.get_trait_by_personality("curiosity"),
                "player_2_goal_extraversion": player_2.get_trait_by_personality("extraversion"),
                "player_2_goal_sensitivity": player_2.get_trait_by_personality("sensitivity"),
                "player_2_goal_gentleness": player_2.get_trait_by_personality("gentleness"),
                "player_2_goal_sincerity": player_2.get_trait_by_personality("sincerity"),
